      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {FEATURES.map((f, index) => (
            <div key={f.title} className="group relative border border-slate-200 rounded-2xl p-8 flex flex-col gap-4 bg-white shadow-sm hover:shadow-md hover:border-sky-200 hover:-translate-y-1 transition-all duration-300 overflow-hidden" style={{ animationDelay: `${index * 0.1}s` }}>
